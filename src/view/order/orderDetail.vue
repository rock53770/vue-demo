<template>
  ...
  <div class="ft16">
    <template v-if="!isLoading">
      ...
      <!-- 险种名称 总额 -->
      <div class="h100 bg-white ta-c pt16 pb16 mb15 order-header">
        <h3 class="fw-n ft16 mb5 cl-white lh22">{{ dataObject.companyName }}</h3>
        <p class="ft25 lh36 cl-white">
          {{(dataObject.commercialInsurancePremium+dataObject.compulsoryInsurancePremium+dataObject.vehicleVesselTax)
          |currency('￥','2')}}</p>
      </div>
      <!-- 商业险 -->
        ...
        <div class="van-hairline--bottom">
          ...
          <div class="ta-c plr12 ft14 flex-center" v-for="(item, index) in commercialInsurance" :key="index">
            ...
            <p style="width: 22%;" class="pt10 pb10">
              <van-icon name="success" color="#FC7453" v-if="item.additionalInsuranceType"/>
            </p>
          ...
          <div class="h60 pt8 plr12 van-hairline--top van-hairline--bottom">
            <div class="ta-r ft14 mb8 flex-center">
              <div style="width: 34%" class="fw-b ta-l">
                <p v-if="dataObject.discountRate">折扣率：<strong class="cl-orange">{{ dataObject.discountRate|currency2
                  }}</strong></p>
              </div>
              <div style="width: 22%"></div>
              <div style="width: 22%" class="fw-b cl-orange">合计：</div>
              <div style="width: 22%" class="ta-r fw-b cl-orange">{{
                dataObject.commercialInsurancePremium|currency2('￥','2') }}
              </div>
            </div>
      ...
      <div class="bg-white mb10" v-if="strongInsurance.length">
        ...
        <div class="van-hairline--bottom">
          ...
          <div class="h40 plr12 van-hairline--top van-hairline--bottom">
            <p class="ta-r lh40 ft14 fw-b cl-orange">合计：{{ (dataObject.compulsoryInsurancePremium +
              dataObject.vehicleVesselTax) |currency('￥','2') }}</p>
          </div>
        </div>
      </div>
      <!-- 备注 -->
      ...
      <!--<div class="bg-white ft16">-->
        ...
        <!--<div class="info plr12 mb10">-->
          ...
          <!--</div>-->
          <!--&lt;!&ndash; <div class="lh50 van-hairline&#45;&#45;bottom">-->
...
<style lang="less" scoped>
  ...
  .order-header {
    .bg-img-set('~@/assets/images/order_detail_header@2x.png', '~@/assets/images/order_detail_header@3x.png', 100%, 100%);
  }
</style>
