...
.use(vant.CheckboxGroup).use(vant.DatetimePicker).use(vant.ImagePreview).use(vant.Dialog).use(vant.List)
.use(vant.PullRefresh).use(vant.Collapse).use(vant.CollapseItem)
