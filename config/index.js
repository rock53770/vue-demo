...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/mock': {
        target: 'http://192.168.100.221:8080/',                //mock环境代理
  ...
  build: {
    ...
    assetsSubDirectory: 'static',
    assetsPublicPath: process.env.IS_APP ? './' : "/",
    ...
    chunkhashName: process.env.IS_APP ? '' : '.[chunkhash:6]',
		timeStamp: process.env.IS_APP ? '?'+ (+new Date()) : ''
  }
}
